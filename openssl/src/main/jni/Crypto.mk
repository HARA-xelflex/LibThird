...
LOCAL_SDK_VERSION := $(strip $(subst android-,,$(APP_PLATFORM)))

# Defining this variable as arm forces the build system to generate the module's object files in 32-bit arm mode.
LOCAL_ARM_MODE := arm
